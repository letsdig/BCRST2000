...
This setup is useful if one have a lot of folders full of loops or samples (128 banks per track and max 128 sounds per bank). If your folder exceed 128 samples/loops in one folder just split it in two different folders.
...
- solo
- speed
- evaluate atom block code or single row and move in the editor, all by midi - play
- hush - stop
